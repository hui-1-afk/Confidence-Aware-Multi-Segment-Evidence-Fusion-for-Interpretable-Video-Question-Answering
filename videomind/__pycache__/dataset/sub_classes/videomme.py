...
class VideoMMEDataset(Dataset):
    ...
    ANNO_PATH = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/videomme/test-00000-of-00001.parquet'

    VIDEO_ROOT = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/videomme/videos'
    SUBTITLE_ROOT = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/videomme/subtitles'
