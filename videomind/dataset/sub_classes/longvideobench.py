...
class LongVideoBenchDataset(Dataset):
    ...
    ANNO_PATH_VALID = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/longvideobench/lvb_val.json'
    ANNO_PATH_TEST = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/longvideobench/lvb_test_wo_gt.json'

    VIDEO_ROOT = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/longvideobench/videos'
