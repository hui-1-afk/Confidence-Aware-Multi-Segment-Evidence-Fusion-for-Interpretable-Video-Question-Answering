...
class NExTQADataset(AnsweringDataset):
    ...
    ANNO_PATH_TRAIN = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/nextqa/train.csv'
    ANNO_PATH_VALID = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/nextqa/val.csv'
    ANNO_PATH_TEST = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/nextqa/test.csv'

    VIDEO_ID_MAP = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/nextqa/map_vid_vidorID.json'
    VIDEO_ROOT = '/HOME/nsccgz_zgchen/nsccgz_zgchen_6/HDD_POOL/veot/datasets/nextqa/videos'
